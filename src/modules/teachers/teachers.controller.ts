...
export class TeachersController {
  ...
  @ApiResponse({
    ...
    description: 'Staff already suspended.',
  })
  ...
  @ApiResponse({
    status: HttpStatus.BAD_REQUEST,
    description: 'Staff already active.',
  })
  ...
  async updateAvatar(
    ...
    if (!file) {
      throw new BadRequestException(
        'No file uploaded or file is too large (max 2MB)',
      );
    }
  ...
  @ApiResponse({
    status: HttpStatus.BAD_REQUEST,
    description: 'Invalid data or passwords do not match.',
  })
  @ApiResponse({
    status: HttpStatus.NOT_FOUND,
    description: 'Staff not found.',
  ...
  async changePassword(
    ...
    const data = await this.teachersService.changePassword(
      id,
      changePasswordDto,
    );
    return res.status(HttpStatus.OK).json({
  ...
  @ApiOperation({
    summary:
      'Fetch classes and arms assigned to a particular teacher in a school',
  })
  @ApiParam({ name: 'id', description: 'The unique ID of the teacher' })
  @ApiParam({ name: 'schoolId', description: 'The unique ID of the school' })
  @ApiResponse({
  ...
  @ApiOperation({
    summary: 'Fetch students based on the classes assigned to the teacher',
  })
  @ApiParam({ name: 'id', description: 'The unique ID of the teacher' })
  @ApiParam({ name: 'schoolId', description: 'The unique ID of the school' })
  @ApiResponse({
    status: HttpStatus.OK,
    description:
      'List of students assigned to the teacher retrieved successfully.',
  })
  @ApiResponse({
    status: HttpStatus.NOT_FOUND,
    description: 'Teacher or school not found.',
