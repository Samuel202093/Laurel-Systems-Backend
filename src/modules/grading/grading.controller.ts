...
export class GradingController {
  ...
  @Get(':schoolId')
  @ApiOperation({
    summary: 'Get grading system configuration for a specific session/term',
  })
  ...
  @ApiResponse({
    ...
    description: 'Grading system retrieved.',
  })
  async getGradingSystem(
    ...
    const data = await this.gradingService.getGradingSystem(
      schoolId,
      sessionId,
      termId,
    );
  ...
  @ApiResponse({
    status: HttpStatus.OK,
    description: 'Grading system updated.',
  })
